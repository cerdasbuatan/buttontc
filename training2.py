...
from keras_preprocessing.sequence import pad_sequences  # Untuk melakukan padding pada sequence
from keras_preprocessing.text import Tokenizer  # Untuk tokenisasi teks
